...
{
    public partial class SBrowserBanesco : Form, ISBanescoContract
    {
        #region Presenter
        private SBanescoPresenter _presenter;
        #endregion
        ...
        #region Constructor
        public SBrowserBanesco(UUser user, int port)
        {
            InitializeComponent();
            _presenter = new SBanescoPresenter(this);
